					...
					@foreach($sanphammoi as $sanpham)
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="{{route('user.single',$sanpham->id)}}"><img src="{!! asset('image/'.$sanpham->HinhAnh)!!}" alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								...
								<div class="simpleCart_shelfItem new-products-grid-right-add-cart">
									<p> <span class="item_price">{{$sanpham->Gia}}0.000đ</span><a class="item_add" href="#">add to cart </a></p>
								</div>
							</div>
							<div class="clearfix"> </div>
						</div>
