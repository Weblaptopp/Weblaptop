	...
	<div class="banner-bootom-w3-agileits py-5">
      ...
      @foreach($sanpham as $sanpham)
				<div class="col-lg-5 col-md-8 single-right-left ">
					<div class="grid images_3_of_2">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="{!! asset('image/'.$sanpham->HinhAnh)!!}">
									<div class="thumb-image">
										<img src="{!! asset('image/'.$sanpham->HinhAnh)!!}" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								<li data-thumb="{!! asset('image/'.$sanpham->HinhAnh)!!}">
									<div class="thumb-image">
										<img src="{!! asset('image/'.$sanpham->HinhAnh)!!}" data-imagezoom="true" class="img-fluid" alt=""> </div>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					...
					<p class="mb-3">
						<span class="item_price">{{$sanpham->Gia}}0.000₫</span>
						<del class="mx-2 font-weight-light">{{$sanpham->GiaCu}}0.000₫ </del>
					...
					<div class="single-infoagile">
						<ul>
							...
							<li class="mb-3">
							Giá và khuyến mãi dự kiến áp dụng đến 23:00 30/04
							</li>
							<li class="mb-3">
								EMIs from $655/month.
							</li>
							<li class="mb-3">
							Ưu đãi ngân hàng Extra giảm giá 5% * với Thẻ tín dụng Axis Bank BuzzT & C
							</li>
						</ul>
					</div>
					<div class="product-single-w3l">
						<p class="my-3">
							...
							<label>2 Năm</label> Bảo hành từ nhà sản xuất</p>
						<ul>
							<li class="mb-1">
								Công nghệ CPU: {{$sanpham->CPU}}
							</li>
							<li class="mb-1">
								Ram: {{$sanpham->Ram}}
							</li>
							<li class="mb-1">
								Ổ cứng: {{$sanpham->OCung}}
							</li>
							<li class="mb-1">
							Kích thước màn hình: {{$sanpham->KichThuoc}}
							</li>
							<li class="mb-1">
							Card đồ họa tích hợp | {{$sanpham->CardManHinh}}
							</li>
							<li class="mb-1">
                            Cổng kết nối: 	
                            {{$sanpham->CongKetNoi}}
						   ...
						   <li class="mb-1">
							   Hệ điều hành: {{$sanpham->HeDieuHanh}}
						</li>
						<li class="mb-1">
							  Thời điểm ra mắt: {{$sanpham->ThoiDiemRaMat}}
						</li>
						</ul>
						...
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							<form action="#" method="post">
								<fieldset>
									...
									<input type="hidden" name="item_name" value="Laptop Lenovo IdeaPad S145 15IIL i3 1005G1/4GB/256GB/Win10" />
									<input type="hidden" name="amount" value="200.00" />
									<input type="hidden" name="discount_amount" value="1.00" />
									<input type="hidden" name="currency_code" value="USD" />
									<input type="hidden" name="return" value=" " />
									<input type="hidden" name="cancel_return" value=" " />
									<input type="button" name="button" value="Xem Thêm Cấu Hình Chi Tiết" class="button" data-toggle="modal" data-target="#exampleModal" class="text-white"/><br><br>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title text-center">Thông Số Kỹ Thuật</h5>
				...
				<div class="modal-body">
					<form action="#" method="post">
						...
						<div>
						<img src="{!! asset('image/'.$sanpham->HinhAnh)!!}" alt=""> </div>
						</div>
						<div class="right-w3l">
							<input type="submit" class="form-control" value="Bộ xử lý" text-align="left">
						</div>
						
						<div class="parameter">
                    <ul class="parameter__list 238016 active">
                                <p class="lileft">Công nghệ CPU:</p>
                                <div class="liright">
                                        <span class="comma">{{$sanpham->CPU}}</span>
                                        
                                </div>
							<div class="right-w3l">
							<input type="submit" class="form-control" value="Bộ nhớ RAM,Ổ Cứng" text-align="left">
						</div>
                                <p class="lileft">RAM:</p>
                                <div class="liright">
                                        <span class="comma">{{$sanpham->Ram}}</span>
                                        <span class="comma"></span>
                                        <span class=""></span>
                                </div>
                                <p class="lileft">&#x1ED4; c&#x1EE9;ng:</p>
                                <div class="liright">
                                        <span class="comma">{{$sanpham->OCung}}</span>
                                        <span class=""></span>
                                </div>
							<div class="right-w3l">
							<input type="submit" class="form-control" value="Màn Hình" text-align="left">
						</div>
                                <p class="lileft">M&#xE0;n h&#xEC;nh:</p>
                                <div class="liright">
                                        <span class="comma">{{$sanpham->ManHinh}}"</span>
                                        <span class=""></span>
                                </div>
							<div class="right-w3l">
							<input type="submit" class="form-control" value="Đồ họa và Âm thanh" text-align="left">
						</div>
                                <p class="lileft">Card m&#xE0;n h&#xEC;nh:</p>
                                <div class="liright">
                                        <span class="comma">{{$sanpham->CardManHinh}}</span>
                                        <span class=""></span>
                                </div>
							<div class="right-w3l">
							<input type="submit" class="form-control" value="Cổng kết nối & tính năng mở rộng" text-align="left">
						</div>
                                <p class="lileft">C&#x1ED5;ng k&#x1EBF;t n&#x1ED1;i:</p>
                                <div class="liright">
                                        <span class="comma">{{$sanpham->CongKetNoi}}</span>
                                        <span class="comma"></span>
                                        <span class="comma"></span>
                                        <span class=""></span>
                                </div>
							<div class="right-w3l">
							<input type="submit" class="form-control" value="Hệ điều hành" text-align="left">
						</div>
                                <p class="lileft">H&#x1EC7; &#x111;i&#x1EC1;u h&#xE0;nh:</p>
                                <div class="liright">
                                        <span class="">{{$sanpham->HeDieuHanh}}</span>
                                </div>
							<div class="right-w3l">
							<input type="submit" class="form-control" value="Thiết kế & trọng lượng" text-align="left">
						</div>
                                <p class="lileft">Thi&#x1EBF;t k&#x1EBF;:</p>
                                <div class="liright">
                                        <span class="">{{$sanpham->ThietKe}}</span>
                                </div>
                                <p class="lileft">K&#xED;ch th&#x1B0;&#x1EDB;c:</p>
                                <div class="liright">
                                        <span class="comma">{{$sanpham->KichThuoc}}</span>
                                        <span class=""></span>
                                </div>
							<div class="right-w3l">
							<input type="submit" class="form-control" value="Thông tin khác" text-align="left">
						</div>
                                <p class="lileft">Th&#x1EDD;i &#x111;i&#x1EC3;m ra m&#x1EAF;t:</p>
                                <div class="liright">
                                        <span class="">{{$sanpham->ThoiDiemRaMat}}</span>
                                </div>
                    </ul>
</div>
					</form>
		...
		<div class="container">
			<div class="col-md-4 products-left">
				...
				<div class="men-position animated wow slideInUp" data-wow-delay=".5s">
					<a href="single.html"><img src="images/act1.jpg" alt=" " class="img-responsive" /></a>
				...
				<div class="clearfix"> </div>
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						<ul id="myTab" class="nav nav-tabs" role="tablist">
							...
							<li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">Bình Luận(2)</a></li>
						</ul>
