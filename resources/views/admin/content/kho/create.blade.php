...
@section('content')
<form method="POST" enctype="multipart/form-data" action="{{route('kho.store')}}">
    {{ csrf_field() }}
   ...
   <div class="form-group">
     <label for="TonKho">Số Lượng Tồn</label>
     <input type="text" class="form-control" name="TonKho" required>
   </div>
  <div class="form-group">
